...
jwp = JWTManager(app) # allow our app to use JWTManager from anywhere
...
app.json_encoder = JSONEncoder # we are not instantiating this but rather poiting to this class
