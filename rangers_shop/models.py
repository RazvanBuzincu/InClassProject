...
def load_user(user_id):
    ...
    """
    return User.query.get(user_id) # this is probably the most basic query, just grabs the row/object associaated with that primary key
...
# only need this for purpose of tracking what customers are tied to which orders
